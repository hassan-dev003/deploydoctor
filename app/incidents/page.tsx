import { AlertTriangle, ArrowLeft, CalendarClock, Inbox, Lock } from "lucide-react";
      ...
      <section className="mx-auto max-w-4xl space-y-4">
        ...
        <header className="space-y-2">
          ...
          <p className="max-w-2xl text-sm leading-6 text-slate-600">
            This page lists placeholder incidents created from Vercel deployment failure webhooks.
            It does not fetch private deployment logs or connect Vercel accounts yet.
          </p>
        </header>
        ...
        <div className="rounded-lg border border-slate-200 bg-slate-50 p-4 text-sm text-slate-700">
          ...
          <p>
            Stored webhook incidents contain sanitized webhook metadata only. Raw deployment logs are
            not fetched or persisted in Milestone 7A.
          </p>
        </div>
      </section>
    </main>
